...
export default function NotFound() {
  return (
    <div className="flex min-h-[80svh] flex-col items-center justify-center px-4 text-center">
      <p className="font-display text-fest text-5xl font-semibold sm:text-7xl">404</p>
      <h1 className="font-display mt-4 text-xl font-semibold sm:text-2xl">This page missed its cue</h1>
